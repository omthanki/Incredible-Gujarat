                    ...
                    <div class="col-md-3">
                        <div class="car-wrap ftco-animate">
                            ...
                            <div class="text p-4 text-center">
                                <h2 class="mb-0"><a style="color: blue;" href="information.php?i=<?php echo $row['Title']?>"><?php echo $row["Title"]; ?></a></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services">
                            <div class="media-body py-md-4">
                                ...
                                <p>Our Website Provide You A Very Huge Source Of Information in One Website</p>
