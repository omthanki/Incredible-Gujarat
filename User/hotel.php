...
<html lang="en">
    ...
    <body>
        ...
        <div style="background-color: gray;" data-stellar-background-ratio="0.5">
            ...
            $s = "SELECT * FROM hotel WHERE Hotel_id = '$id' ";
            ...
            <div class="hotel"> 
            	...
            	<h2 style="color: orange; padding-top: 200px; padding-left: 210px;"><?php echo $row['Name']; ?></h2>

            <div class="image">

                <img src="<?php echo trim($img); ?>" height="390px" width="590px"><br>

            </div>

            	<br>

            	<h5 style="padding-left: 230px; color: white;">Address: <?php echo $row['Address']; ?></h5><br>
            	<h5 style="padding-left: 230px; color: white;">Contact no: <?php echo $row['Contact']; ?></h5>
