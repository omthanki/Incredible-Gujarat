<?php
    ...
    $s = "SELECT * from user_registration WHERE Email_id = '$useremail'";
    ...
    <body>
        ...
        <div style="background-color: gray" data-stellar-background-ratio="0.5">
            ...
            if (isset($_POST['search'])){
                ...
                {
                    echo '<script>alert("Invalid Place Name")</script>';
                    header('location: index.php');
                }
            ...
            <form method="post" action="">
                ...
                <div class="input-group">
                    <label>Name</label>
                    <input type="text" name="name" value="<?php echo "$fname $lname" ?>" readonly>
                </div>
                        ...
                        <div class="col-md-3">
                            <div class="car-wrap ftco-animate">
                                ...
                                <div class="text p-4 text-center">
                                    <h2 class="mb-0"><a style="color: #fff;" href="hotel 1.php?hi=<?php echo $row3['Hotel_id'] ?>"><?php echo $row3["Name"]; ?></a></h2>
                                </div>
                            </div>
            ...
            <section class="ftco-section">
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        $s1 = "SELECT * FROM places WHERE city = '$city' AND Place_id != '$i' AND Category != 'Beautiful Cities' ";
                        ...
                        <div class="col-md-3">
                            <div class="car-wrap ftco-animate">
                                ...
                                <div class="text p-4 text-center">
                                    ...
                                    <h2 class="mb-0"><a style="color: #fff;" href="nearbyplaces 1.php?i=<?php echo $row1['Title']?>"><?php echo $row1["Title"]; ?></a></h2>
...
<?php
  ...
  if(isset($_POST['comment']))
  {
      ...
      $s2 = "SELECT * FROM user_registration WHERE Email_id = '$email' AND Disabled = 'no' ";

      $qry2 = mysqli_query($con, $s2);
      ...
      if(mysqli_num_rows($qry2) > 0)
      {
          ...
          elseif(ctype_punct($message)) {
            ...
            $sel1 = "SELECT * FROM places WHERE Title = '$t' ";

            $res1 = mysqli_query($con, $sel1);
            $row1 = mysqli_fetch_assoc($res1);

            $placeid = $row1['Place_id'];
            $placename = $row1['Title'];

            $i = "INSERT INTO places_comment (User_id, Place_id, Place_name, Message, Status) VALUES ('$email', '$placeid', '$placename', '$message', 'Visible')";
      ...
      {
          echo '<script>alert("You cannot comment because you are disabled.")</script>';
      }
  }
