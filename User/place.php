                        ...
                        <div class="col-md-3">
                            <div class="car-wrap ftco-animate">
                                ...
                                <div class="text p-4 text-center">
                                    ...
                                    <h2 class="mb-0"><a style="color: white;" href="information.php?i=<?php echo $row['Title']?>"><?php echo $row["Title"]; ?></a></h2>

                                    <span style="color: orange;"><?php echo $row['City'];?></span>
                
                                    <p class="d-flex mb-0 d-block"><a href="information.php?i=<?php echo $row['Title']?>" class="btn btn-black btn-outline-black mr-1">Information</a> <a href="location.php?t=<?php echo $row['Title'] ?>" class="btn btn-black btn-outline-black ml-1">Location</a></p>
