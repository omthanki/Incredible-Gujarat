        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a href="photos.php" class="nav-link">Photos</a></li>
		...
		<div class="header">
		  ...
		  <form method="post" action=""  enctype="multipart/form-data">
		  	<div class="input-group">
		  		...
		  		<select name="placename" class="input-group" required>

				<?php

					$sel = "SELECT * FROM places ORDER BY Title";
		  	...
		  	<div class="input-group">
		  		<button type="submit" class="btn" name="addphoto">Add</button>
		  	</div>
		  </form>
		</div>
...
<?php
	...
	if(isset($_POST['addphoto']))
	{
		...
		$s = "SELECT * FROM places WHERE Title = '$placename' ";
		...
		{		
			...
			if(in_array($img_ex_lc, $allowed_exs))
			{
				...
				$query = "INSERT INTO places_photo (Place_id, Place_name, Image) VALUES ('$i', '$placename', '$img_upload_path')";
