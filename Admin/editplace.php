<?php
	...
	$s = "SELECT * FROM places WHERE Place_id = '$id' ";
	...
	$t = $row['Title'];
	$cy = $row['Category'];
	$d = nl2br(addslashes(trim($row['Description'])));
	$c = $row['City'];
		...
		<div class="header">
		  ...
		  <form method="post" action="edit.php">
		  	<div class="input-group">
		  		<label>ID</label>
		  		<input type="num" name="id" value="<?php echo "$id"?>"  readonly required>
		  	</div>
		  	<div class="input-group">
		  		<label>Title</label>
		  	...
		  	<div class="input-group">
		  		...
		  		<textarea name="desc" rows="10" cols="40" required><?php echo "$d" ?></textarea>
		  	</div>
		  	<div class="input-group">
		  		<label>Category</label>
		  		<input type="text" name="category" value="<?php echo "$cy" ?>" readonly  required>
		  	</div>
		  	<div class="input-group">
		  		<label>City</label>
		  		<input type="text" name="city" value="<?php echo "$c" ?>"  required>
		  	</div>
		  	<div class="input-group">
