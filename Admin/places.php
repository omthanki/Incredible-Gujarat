...
<html>
    ...
    <div class="hero-wrap" style="background-color: gray;" data-stellar-background-ratio="0.5">
      ...
      <br><br><br><br><br><br>
		...
		<div class="add">
			<a href="addplace.php">Add</a>
		</div>

		<?php

			$qry = "SELECT * FROM places ORDER BY Title";
	        ...
	        if (mysqli_num_rows($b) > 0)
	        {
	            ...
	            while($row = mysqli_fetch_assoc($b)) {
	                ...
	                echo    "<td>" . $i . "</td>" .
	                        ...
	                        <td> <img src="<?php echo $row['Images'];?>" height="150px" width="150px"> </td>
	                        <td> <img src="<?php echo $row['Location'];?>" height="150px" width="150px"></td>
	                        <td> <a href="editplace.php?id= <?php echo $row['Place_id'] ?> " >Edit</td>
	                        <td> <a href="places.php?Place_id= <?php echo $row["Place_id"] ?> " onclick='return deleteplace();'>Delete</a> </td>
	    	    ...
	    	    echo '<script>alert("No places found.")</script>';
	    	}
        ?>
    </div>
...
<?php
	...
	{
		$id = trim($_GET['Place_id']);

		$d = "DELETE FROM places WHERE Place_id = '$id' ";
