        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a href="admin.php" class="nav-link">Admins</a></li>
    ...
    <div class="hero-wrap" style="background-color: gray;" data-stellar-background-ratio="0.5">
		...
		<div class="header">
		  ...
		  <form method="post" action="">
		  	...
		  	<div class="input-group">
		  		<button type="submit" class="btn" name="addadmin">Add</button>
		  	</div>
		  </form>
...
<?php
	...
	if(isset($_POST['addadmin']))
	{
		...
		$s = "SELECT * from admin_login where Email_id = '$email' LIMIT 1";
		...
		elseif (strlen($password) < 8) {
			...
			$query = "INSERT INTO admin_login (Name, Email_id, Password) VALUES ('$name', '$email', '$password1')";
