...
<html>
    ...
    <div class="hero-wrap" style="background-color: gray;" data-stellar-background-ratio="0.5">
      ...
      <br><br><br><br><br><br>
		...
		<div class="add">
			<a href="addphotos.php">Add</a>
		</div>

		<?php

			$qry = "SELECT * FROM places_photo ORDER BY Place_name";
	        ...
	        if (mysqli_num_rows($b) > 0)
	        {
	            ...
	            while($row = mysqli_fetch_assoc($b)) {
	                ...
	                echo    "<td>" . $i . "</td>" .
	                        ...
	                        <td> <a href="photos.php?id= <?php echo $row["Id"] ?> " onclick='return deletephoto();'>Delete</a> </td>
	                <?php
	                echo "</tr>";
	    	    ...
	    	    echo '<script>alert("No photos found.")</script>';
	    	}
        ?>
...
<?php
	...
	if (isset($_GET['id']))
	{
		...
		$d = "DELETE FROM places_photo WHERE ID = '$id' ";
