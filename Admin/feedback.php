          ...
          if (mysqli_num_rows($b) > 0)
          {
              ...
              while($row = mysqli_fetch_assoc($b)) {
                  ...
                  echo    "<td>" . $i . "</td>" .
                          ...
                          "<td>" . $row["Email_id"] . "</td>" .
                          "<td>" . $row["Message"] . "</td>"; ?>
                          <td> <a href="feedback.php?Emailid= <?php echo $row["Email_id"] ?> " onclick='return deletefeedback();'>Delete</a> </td>
                  <?php
                  echo "</tr>";
            ...
            echo '<script>alert("No feedbacks found.")</script>';
        }
        ?>
...
<?php
    ...
    if(isset($_GET['Emailid']))
    {
        ...
        $d = "DELETE FROM feedback WHERE Email_id = '$email'";
